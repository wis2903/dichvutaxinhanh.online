            ...
            <Wrapper className={styles.wrapper}>
                ...
                <div className={styles.items}>
                    <div className={styles.item}>
                        ...
                        <div className={styles.label}>Xe đi sân bay Tân Sơn Nhất</div>
                    ...
                    <div className={styles.item}>
                        ...
                        <div className={styles.label}>Xe đi Bình Dương</div>
                        <div className={styles.action}>
                            {
                                isMobile
                                ?
                    ...
                    <div className={styles.item}>
                        ...
                        <div className={styles.label}>Xe đi Vũng Tàu</div>
                        <div className={styles.action}>
                            {
                                isMobile
                                ?
                    ...
                    <div className={styles.item}>
                        ...
                        <div className={styles.label}>Du lịch Đà Lạt</div>
                        <div className={styles.action}>
                            {
                                isMobile
                                ?
